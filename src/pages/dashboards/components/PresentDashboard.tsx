              ...
              {combinedData.map((item, index) => (
                <div
                  ...
                  style={{ 
                    ...
                    backgroundColor: item.visualType === "Gauge" ? 'transparent' : (item.visualSettings?.backgroundColor || item.backgroundColor || '#ffffff')
                  }}
                >
                  <div className="w-full">
                    ...
                    <div 
                      className="h-full" 
                      style={{
                        backgroundColor: item.visualType === "Gauge" ? 'transparent' : (item.visualSettings?.backgroundColor || item.backgroundColor || 'transparent')
                      }} 
                    >
